...
# Sat Mar 19 04:56:31 2022
###############################################################################
current_design pwm_top
###############################################################################
# Timing Constraints
###############################################################################
...
set_output_delay 7.6000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {irq[0]}]
set_output_delay 7.6000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {irq[1]}]
set_output_delay 7.6000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {irq[2]}]
